...
class Signal_Generator(object):
    ...
    def power_down(self):
        if self.alive:
            ...
            try: 
                ...
                print("ERROR IN POWER DOWN SIGGEN")
            self.rf_off()
            self.siggen.close()
            # self.alive = False
    ...
    def __del__(self):
        self.power_down()
            # maybe the tests that work don't call power down?
